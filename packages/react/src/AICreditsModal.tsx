...
export interface AICreditsModalProps {
  ...
  tagline?: string;
  accentColor?: string;
  /** Render embedded inside a container instead of fullscreen fixed overlay */
  isInline?: boolean;
}
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <div
              style={{
                ...
                height: "40px",
                borderRadius: "12px",
                background: "linear-gradient(135deg, #371d73 0%, #1e1140 100%)",
            ...
            <div>
              <h2 style={{ fontSize: "21px", fontWeight: 700, color: "#ffffff", letterSpacing: "-0.02em", margin: 0, lineHeight: 1.2 }}>
                {title}
              </h2>
          ...
          >
            ...
            <div style={{ color: "rgba(255, 255, 255, 0.35)", cursor: "pointer" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", gap: "16px" }}>
          ...
          {/* 3 Trust Features (Outline vector icons matching reference) */}
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "10px", paddingTop: "14px", borderTop: "1px solid rgba(255, 255, 255, 0.08)" }}>
            ...
            <div>
              ...
              <p style={{ fontSize: "9px", color: "rgba(255, 255, 255, 0.4)", margin: "3px 0 0", lineHeight: 1.35 }}>
